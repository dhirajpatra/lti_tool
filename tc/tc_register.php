...
$oauth_consumer_key = '98765asd';
$oauth_consumer_secret = 'secret';

$response = '{
  "@context": "http://purl.imsglobal.org/ctx/lti/v2/ToolProxyId",
  "@type": "ToolProxy",
  "@id": "http://localhost/toolproxies/0df4b410-9e38-0130-4f3c-406c8f217861",
...
try {
    //print_r(apache_request_headers()); die;
...
$storeDetails = json_decode($json, true);
$tool_proxy_guid = $storeDetails['tool_proxy_guid'];
require_once '../library/tcdatabase.php';
...
$updateArray['tool_proxy_guid'] = $tool_proxy_guid;
$condition = " tc_proxy_reg_key = '".$oauth_consumer_key."'";

$updateStatus = $tcDBObj->updateDataInToTC('tc_proxy_credentials', $updateArray, $condition);
